...
def main():
    ...
    x = x_full[train_indices][0:0.8*len(x_full)]
    y = y_full[train_indices][0:0.8*len(x_full)]
    x_test = x_full[train_indices][0.8*len(x_full):]
    y_test = y_full[train_indices][0.8*len(x_full):]
